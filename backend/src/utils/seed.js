...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/renewcred_cms';
...
const seedDatabase = async () => {
  try {
    ...
    console.log(`[Seed] Admin created: ${admin.email} (Password: Admin@123456)`);

    // Seed Sample Rich Pages
    const pages = [
      {
        title: 'Home',
        slug: 'home',
    ...
    console.log(`[Seed] Seeded ${pages.length} rich pages successfully.`);
